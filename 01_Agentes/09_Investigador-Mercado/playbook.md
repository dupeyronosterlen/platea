...
> Fuentes operativas: `04_Operaciones/mapas-verdad-agencia.md` · modelo $: `campanas/00-MODELO-NEGOCIO.md`

> **Rol dual (actualizado jun 2026):**
> 1. **Estratega de campaña S2** — analiza datos propios (S1 dataset: 178 compradores) para definir mix de boletos, split Meta/Google, segmentos ganadores. Decisiones de gasto contra `campanas/00-MODELO-NEGOCIO.md`.
