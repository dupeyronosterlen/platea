...
def run_estrategia() -> str:
    hoy = datetime.date.today()
    estreno = datetime.date.fromisoformat(CONFIG["temporada"]["estreno_prensa"])
...
─────────────────────────────────
  ...
  Break-even:       {int(50000 / CONFIG['precios']['general'])} boletos a ${CONFIG['precios']['general']} (arranque) / {int(50000 / CONFIG['precios']['general_post_estreno'])} a ${CONFIG['precios']['general_post_estreno']} (post-estreno)
