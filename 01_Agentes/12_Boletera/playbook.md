...
> ⚠️ **Mapa de verdad:** `04_Operaciones/mapas-verdad-agencia.md` · **Producción:** `produccion.yaml` (precios, fechas, `tid` wilberto).
> **Cheque al teatro:** `04_Operaciones/liquidaciones/pagos-teatro/MODELO-PAGO.md` (técnicos al corte, fuera; $6,500 menos Ticketmaster).
> Este rol **no** toca reglas de escalado Meta — solo inventario, venta y alertas.
...
- **Función <50% a 5 días** → 🟡 WhatsApp: proponer subir pauta (Dirección + Ag-03; CPA según `escalado.yaml`). Precio base NO baja.
...
- Precios / funciones / tid: `produccion.yaml`, `plaza-activa.md`
- Arquitectura boletera: `00_Biblias/boletera-arquitectura.md`
- Cortesías manifiesto: `04_Operaciones/cortesias-conocidas.json`
