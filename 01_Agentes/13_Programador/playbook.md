...
> ⚠️ **Checkout/boletera en vivo:** cambios en workers o sitio requieren **va explícito de Dirección** — ver `taquilla/README.md`.
...
- Search Console: sitemap enviado + URLs indexables (`gsc_check.py`), no el botón Request Indexing.
