...
# Banco unificado en la agencia (sin disco La Mancha). Fallback legacy CartelesPeter.
_BANK = REPO / "05_Activos/el-gorila/banco-fotos/personaje-aislado"
_LEGACY = REPO / "07_CartelesPeter/public/assets/photos/personaje-aislado"
FOTOS_DIR = _BANK if _BANK.is_dir() and any(_BANK.glob("*.png")) else _LEGACY
