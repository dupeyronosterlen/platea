...
> ⚠️ **Dueño anti-drift:** `scripts/agencia_drift_check.py` (domingo tras graphify) + `update_context.py` (flush bitácora).
> Mapa verdad: `04_Operaciones/mapas-verdad-agencia.md`
> 📋 **Dueño pendientes:** `04_Operaciones/PENDIENTES-MAESTRO.md` — primer lugar ver faltantes + registrar nuevos (`00_Biblias/pendientes-regla-agencia.md`).
...
- **Autónomo:** analizar, mapear fugas, generar y priorizar hipótesis, redactar recomendaciones; correr drift check y proponer fixes de documentación.
- **Requiere Dirección/CEO:** cualquier ejecución (cambiar pauta, precio, aforo, sitio, workers en vivo).
